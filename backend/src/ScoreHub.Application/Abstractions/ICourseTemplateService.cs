...
public record TemplateModuleDto(int Number, string Title, List<TemplateActivityDto> Activities);
...
public record TemplateModuleView(Guid Id, int Number, string Title, List<TemplateActivityView> Activities);
