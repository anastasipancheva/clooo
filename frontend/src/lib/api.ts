...
export const student = {
  enroll: (courseId: string) =>
    post<{ message: string }>(`/api/student/courses/${courseId}/enroll`),
...
export const admin = {
  listUsers: () =>
    get<{ id: string; email: string; displayName: string; role: string }[]>("/api/admin/users"),
...
export const teaching = {
  ...
  getCourseFull: (courseId: string) =>
    get<CourseFull>(`/api/teaching/courses/${courseId}/full`),
  getEnrolledStudents: (courseId: string) =>
    get<{ id: string; email: string; displayName: string; role: string }[]>(
      `/api/teaching/courses/${courseId}/enrolled-students`
    ),
};
